...
Schedule_t	slAssassinTakeCoverFromEnemy[] =
{
	{ 
		...
		ARRAY_SIZE ( tlAssassinTakeCoverFromEnemy ), 
		bits_COND_NEW_ENEMY |
		bits_COND_CAN_MELEE_ATTACK1		|
		bits_COND_HEAR_SOUND,
...
Schedule_t	slAssassinTakeCoverFromEnemy2[] =
{
	{ 
		...
		ARRAY_SIZE ( tlAssassinTakeCoverFromEnemy2 ), 
		bits_COND_NEW_ENEMY |
...
Schedule_t	slAssassinTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAY_SIZE ( tlAssassinTakeCoverFromBestSound ), 
		bits_COND_NEW_ENEMY,
		0,
...
Schedule_t	slAssassinJumpAttack[] =
{
	{ 
		...
		ARRAY_SIZE ( tlAssassinJumpAttack ), 
		0, 
		0,
		"AssassinJumpAttack"
	},
