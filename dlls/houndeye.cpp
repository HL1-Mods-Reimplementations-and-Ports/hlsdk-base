...
BOOL CHoundeye :: FValidateHintType ( short sHint )
{
	...
	for ( i = 0 ; i < ARRAY_SIZE ( sHoundHints ) ; i++ )
	{
...
Schedule_t	slHoundSpecialAttack1[] =
{
	{ 
		...
		ARRAY_SIZE ( tlHoundSpecialAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slHoundCombatFailPVS[] =
{
	{ 
		...
		ARRAY_SIZE ( tlHoundCombatFailPVS ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE,
		0,
...
Schedule_t	slHoundCombatFailNoPVS[] =
{
	{ 
		...
		ARRAY_SIZE ( tlHoundCombatFailNoPVS ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE,
		0,
