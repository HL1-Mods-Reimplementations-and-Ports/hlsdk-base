...
Schedule_t	slPrimaryMeleeAttack[] =
{
	{ 
		...
		ARRAY_SIZE ( tlPrimaryMeleeAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slSecondaryMeleeAttack[] =
{
	{ 
		...
		ARRAY_SIZE ( tlSecondaryMeleeAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
{
	{
		...
		ARRAY_SIZE ( tlBarnacleVictimGrab ),
		0,
		0,
		"Barnacle Victim"
	}
...
{
	{
		...
		ARRAY_SIZE ( tlBarnacleVictimChomp ),
		0,
		0,
		"Barnacle Chomp"
	}
...
Schedule_t	slTakeCoverFromOrigin[] =
{
	{ 
		...
		ARRAY_SIZE ( tlTakeCoverFromOrigin ), 
		bits_COND_NEW_ENEMY,
		0,
		"TakeCoverFromOrigin"
	},
...
Schedule_t	slTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAY_SIZE ( tlTakeCoverFromBestSound ), 
		bits_COND_NEW_ENEMY,
		0,
...
Schedule_t	slTakeCoverFromEnemy[] =
{
	{ 
		...
		ARRAY_SIZE ( tlTakeCoverFromEnemy ), 
		bits_COND_NEW_ENEMY,
		0,
		"tlTakeCoverFromEnemy"
	},
...
{
	return ScheduleInList( pName, m_scheduleList, ARRAY_SIZE(m_scheduleList) );
}
