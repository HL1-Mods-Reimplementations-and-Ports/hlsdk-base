...
Schedule_t	slGruntVictoryDance[] =
{
	{ 
		tlGruntVictoryDance,
		ARRAY_SIZE ( tlGruntVictoryDance ), 
		bits_COND_NEW_ENEMY		|
...
Schedule_t slGruntEstablishLineOfFire[] =
{
	{ 
		...
		ARRAY_SIZE ( tlGruntEstablishLineOfFire ),
		bits_COND_NEW_ENEMY			|
...
Schedule_t	slGruntSignalSuppress[] =
{
	{ 
		...
		ARRAY_SIZE ( tlGruntSignalSuppress ), 
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
		bits_COND_HEAR_SOUND		|
...
Schedule_t	slGruntGrenadeCover[] =
{
	{ 
		...
		ARRAY_SIZE ( tlGruntGrenadeCover1 ), 
		0,
		0,
		"GrenadeCover"
	},
...
Schedule_t	slGruntTossGrenadeCover[] =
{
	{ 
		...
		ARRAY_SIZE ( tlGruntTossGrenadeCover1 ), 
		0,
		0,
		"TossGrenadeCover"
	},
...
Schedule_t	slGruntTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAY_SIZE ( tlGruntTakeCoverFromBestSound ), 
		0,
		0,
...
Schedule_t	slGruntRangeAttack1A[] =
{
	{ 
		...
		ARRAY_SIZE ( tlGruntRangeAttack1A ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slGruntRangeAttack1B[] =
{
	{ 
		...
		ARRAY_SIZE ( tlGruntRangeAttack1B ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_HEAVY_DAMAGE		|
		bits_COND_ENEMY_OCCLUDED	|
...
Schedule_t	slGruntRangeAttack2[] =
{
	{ 
		tlGruntRangeAttack2,
		ARRAY_SIZE ( tlGruntRangeAttack2 ), 
		0,
		0,
		"RangeAttack2"
	},
