...
BOOL CBullsquid :: FValidateHintType ( short sHint )
{
	...
	for ( i = 0 ; i < ARRAY_SIZE ( sSquidHints ) ; i++ )
	{
...
Schedule_t	slSquidRangeAttack1[] =
{
	{ 
		tlSquidRangeAttack1,
		ARRAY_SIZE ( tlSquidRangeAttack1 ), 
		bits_COND_NEW_ENEMY			|
