...
// sound functions
inline void PLAY_SOUND( char *szSound, float vol ) { gEngfuncs.pfnPlaySoundByName( szSound, vol ); }
inline void PLAY_SOUND( int iSound, float vol ) { gEngfuncs.pfnPlaySoundByIndex( iSound, vol ); }
